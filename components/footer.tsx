                    ...
                    <div className='space-y-8'>
                        <div>
                            ...
                            <div className='space-y-4'>
                                <a
                                    href='mailto:info@youngturtle.in'
                        ...
                        <div>
                            <div className='flex items-start gap-3 text-white'>
                                ...
                                <div className='text-sm leading-relaxed'>
                                    ...
                                    <p>
                                        4th Floor, Safal Profitaire, A-6,
                                        <br />
                                        Corporate Rd, opp. AUDA Garden, Satellite, Prahlad Nagar,
                                        <br />
                                        Ahmedabad, Gujarat
                                        <br />
                                        India - 380015
                        ...
                        <ul className='space-y-3 text-sm text-slate-300'>
                            {[
                                ...
                                <li key={item}>
                                    <a
                                        href='#'
                                        className='hover:text-white hover:translate-x-1 inline-flex items-center gap-2 transition-all group'
                                    >
                ...
                <div className='py-12 border-t border-white/10'>
                    <div className='bg-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-sm space-y-6 text-xs sm:text-sm text-slate-300 leading-relaxed'>
                        <div>
                            ...
                            <p>
                                SEBI Registered Portfolio Manager. Registration and other regulatory details will be
                                updated here. Young Turtle is committed to transparency and investor protection.
                            </p>
                        </div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 pt-4'>
                            <div className='space-y-1'>
                                ...
                                <p>
                                    Email:{' '}
                                    <a
                                        href='mailto:compliance@youngturtle.in'
                        ...
                        <p className='pt-4 border-t border-white/10 text-xs'>
                            ...
                            investment requirements before choosing a scheme.
                        </p>
                    </div>
                </div>
