        ...
        <div className='relative text-center px-4 sm:px-6 md:px-8 max-w-6xl mx-auto'>
            ...
            <div className='relative z-10'>
                ...
                <h1
                    ...
                    '
                >
                    <span className='text-[#ffb900] font-bold'>Mathematics</span> Over{' '}
                ...
                <div className='space-y-3 max-w-4xl mx-auto'>
                    ...
                    <p
                        ...
                        '
                    >
                        We build <span className='text-[#ffb900] font-medium'>rigorous, quantitative approaches</span>{' '}
                        as <span className='text-[#ffb900] font-medium'>numbers reveal truth.</span>
                    </p>
                </div>
            </div>
        </div>
