                            ...
                            <ul className="flex gap-8 text-2xl">
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className={cn("text-white text-lg hover:text-accent-foreground block duration-150", isScrolled && 'text-white')}>
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
                                ...
                                <ul className="space-y-6 text-base">
                                    {menuItems.map((item, index) => (
                                        <li key={index}>
                                            <Link
                                                href={item.href}
                                                className={cn("text-white hover:text-accent-foreground block duration-150", isScrolled && 'text-white')}>
                                                <span>{item.name}</span>
                                            </Link>
                                        </li>
                                    ))}
