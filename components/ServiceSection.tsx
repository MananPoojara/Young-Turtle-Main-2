            ...
            <section className='relative w-full py-28 overflow-hidden bg-[#275669] flex items-center justify-center border-t border-white/[0.03]'>
                ...
                <div className='relative z-20 container mx-auto px-6 text-center'>
                    ...
                    >
                        ...
                        <span className='text-[#fbbf24] font-normal italic'>looking backward</span>.”
                        <br />{' '}
                        <span className='text-md 2xl:text-md xl:text-lg md:text-base lg:text-lg text-white/70 font-light tracking-normal'>
                            – Steve Jobs
                        </span>
                    </motion.h2>
                </div>
