                            ...
                            >
                                <div className='mb-10'>
                                    ...
                                    <p className='mt-4 text-slate-500 leading-relaxed'>
                                        Please fill out the form below. Our investor relations team typically responds
                                        ...
                                        <div className='space-y-6'>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <p className='text-lg font-light text-white group-hover:text-aqua-mist transition-colors'>
                                    ...
                                    <div className='pt-8 border-t border-white/20'>
                                        ...
                                        {offices.map((office, idx) => (
                                            <div key={idx} className='mb-6'>
                                                ...
                                                <h4 className='font-serif text-xl text-abyssal-blue mb-2'>
                                                    {office.city}
                                                </h4>
            ...
            <SectionWrapper className='py-16 bg-white'>
                <div className='max-w-4xl mx-auto px-6 lg:px-8 text-center'>
                    <p className='text-xs text-muted-foreground leading-relaxed'>
                        By submitting this form, you acknowledge that Young Turtle Capital Management may contact you
